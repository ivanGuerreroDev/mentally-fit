			...
			<div className="row">
				<div className="col-md-8 col-12">
					...
					<div className="texto-container">
						<div className="">
							<h3>Gestión de la energía espiritual</h3>
							<p>
								En los siguientes resultados se observan los niveles de energía espiritual en la organización. La espiritualidad en el lugar de trabajo tiene una relevancia con la prosperidad de los empleados, las organizaciones y las sociedades. Conectando la esencia de los trabajadores con sus actividades y tareas, lo que resulta en un mayor motivación, compromiso con la organización y satisfacción laboral, que como último objetivo proporciona firmeza a la organización y aumenta el desempeño de todas las áreas con colaboradores que aportan todo su potencial en el desarrollo de las metas comunes de la institución.
							</p>
						</div>
					</div>
				</div>
