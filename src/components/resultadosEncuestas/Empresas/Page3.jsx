			...
			<div className="row">
				<div className="col-md-8 col-12">
					...
					<div className="texto-container">
						<div className="">
							<h3>Gestión de la energía física</h3>
							<p>
								En esta página se encuentran los resultados en la dimensión de energía física de la totalidad de empleados que tomaron el test, esta dimensión es esencial para el rendimiento diario, tener poca tiene un impacto negativo en la vitalidad de los colaboradores conllevando al aumento de la presión arterial, irritabilidad y disminuyendo la resistencia, volviéndolos más vulnerables a enfermedades y lesiones. Por el contrario, disponer de suficiente energía física tiene un impacto positivo sobre la salud y las capacidades para lidiar con las actividades diarias permitiéndoles ser más productivos de forma más sostenible.
							</p>
						</div>
					</div>
				</div>
