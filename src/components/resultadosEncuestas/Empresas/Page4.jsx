			...
			<div className="row">
				<div className="col-md-8 col-12">
					...
					<div className="texto-container">
						<div className="">
							<h3>Gestión de la energía mental</h3>
							<p>
								Los siguientes resultados refieren a los niveles de energía mental de los colaboradores. La mente es uno de los mayores contribuyentes a los niveles de energía y los beneficios de tener mucha energía incluyen: actitud ganadora, confianza, concentración, mayor fuerza de voluntad, motivación y productividad. Las áreas que cubre esta dimensión son: mentalidad innovadora, mentalidad ganadora, resiliencia y mentalidad de crecimiento, los valores más altos en todas estas zonas hablan de un equipo creativo y curioso, que puede fijarse metas, hacerles seguimiento y cumplirlas con eficiencia, que además sabe sobreponerse a las adversidades, que toma riesgos y aprende de sus errores.
							</p>
						</div>
					</div>
				</div>
